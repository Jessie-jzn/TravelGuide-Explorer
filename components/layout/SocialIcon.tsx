...
const SocialIcon = ({ kind, href, size = 8, theme }: SocialIconProps) => {
  if (
    !href ||
    (kind === 'mail' &&
  ...
  const textColor =
    theme === 'white'
      ...
      : 'text-gray-500 hover:text-gray-600 dark:text-gray-200 dark:hover:text-primary-400';
  ...
  return (
    ...
    >
      ...
      <SocialSvg className={`fill-current ${textColor} h-${size} w-${size}`} />
    </a>
  );
};

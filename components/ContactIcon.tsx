const ContactIcon = ({
  fillColor = 'zinc-500',
  hoverFillColor = 'zinc-600',
  darkFillColor = 'zinc-400',
  darkHoverFillColor = 'zinc-300',
}) => {
  return (
    <div className="flex gap-6">
      ...
      >
        <svg
          ...
          viewBox="0 0 512 512"
          className={`h-6 w-6 fill-${fillColor} transition group-hover:fill-${hoverFillColor} dark:fill-${darkFillColor} dark:group-hover:fill-${darkHoverFillColor}`}
        >

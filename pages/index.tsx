              ...
              <div className="mx-auto max-w-2xl lg:max-w-5xl mt-10">
                <form className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40" action="/thank-you">
                  <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                    ...
                    <span className="ml-3" data-relingo-block="true" data-relin-paragraph="14" data-relingo-parsed="true">订阅</span>
                  </h2>
                  <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400" data-relingo-block="true" data-relin-paragraph="15" data-relingo-parsed="true">订阅我的文章，收到我的最新发布通知，可随时取消订阅。</p>
                  <div className="mt-6 flex">
                    ...
                    <button className="inline-flex items-center gap-2 justify-center rounded-md py-2 px-3 text-sm outline-offset-2 transition active:transition-none bg-zinc-800 font-semibold text-zinc-100 hover:bg-zinc-700 active:bg-zinc-800 active:text-zinc-100/70 dark:bg-zinc-700 dark:hover:bg-zinc-600 dark:active:bg-zinc-700 dark:active:text-zinc-100/70 ml-4 flex-none" type="submit" data-relin-paragraph="37" data-relingo-parsed="true">
                      订阅
                    </button>
                  </div>
                </form>
